    ...
    <div class="layui-form" style="width: 400px;" lay-filter="editForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="username" name="username" value="" lay-verify="required" lay-reqtext="用户名不能为空" placeholder="请输入用户名" class="layui-input">
            </div>
        </div>
        <!--密码-->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="password" name="password" value="" placeholder="请输入密码" class="layui-input">
            </div>
        </div>
        <!--姓名-->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="name" name="name" value="" lay-verify="required" lay-reqtext="姓名不能为空" placeholder="请输入姓名" class="layui-input">
            </div>
        </div>
        <!--备注-->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="remark" name="remark" value="" placeholder="请输入备注" class="layui-input">
            </div>
        </div>
