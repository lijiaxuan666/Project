...
<%--编辑弹出框--%>
<div class="site-text" style="margin: 5%; display: none" id="search_window">
    <div class="layui-form" style="width: 700px;" lay-filter="editForm">
...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="search">查看</a>
            ...
            if (obj.event === 'search') { //监听编辑按钮
                var index = layer.open({
                    ...
                    success: function () {
                        ...
                        table.render({
                            elem: '#currentTable',
                            url: 'student/queryClassStudents.do',
                            where: {clazz:cid},
                            cols: [[
