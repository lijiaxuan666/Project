...
<div class="site-text" style="margin: 5%; display: none" id="edit_window">
    <div class="layui-form" style="width: 400px; float: left" lay-filter="editForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="entime" name="entime" value="" lay-verify="date" placeholder="请选择入校时间" class="layui-input">
            </div>
        </div>
        <!--登录密码-->
        <div class="layui-form-item">
...
<script>
    ...
    layui.use(['form', 'table','laydate', "upload", "element", "layer"], function () {
        ...
        var uploadInst = upload.render({
            elem: "#test1",
            url: "upload/uploadImg.do", //此处用的是第三方的 http 请求演示，实际使用时改成您自己的上传接口即可。
            before: function (obj) {
                //预读本地文件示例，不支持ie8
