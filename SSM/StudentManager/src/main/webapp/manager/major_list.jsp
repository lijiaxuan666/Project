...
<div class="site-text" style="margin: 5%; display: none" id="edit_window">
    <div class="layui-form" style="width: 400px;" lay-filter="editForm">
        <%--隐藏域，sid--%>
        <input type="hidden" id="mid" name="mid" class="layui-input" value="null">
        <!--专业名-->
        <div class="layui-form-item">
            <label class="layui-form-label">专业名</label>
            <div class="layui-input-block">
                <input type="text" id="mname" name="mname" value="" lay-verify="required" lay-reqtext="专业名不能为空" placeholder="请输入姓名" class="layui-input">
            </div>
        </div>
        <!--院系-->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="mdept" name="mdept" value="" placeholder="请输入院系" class="layui-input">
            </div>
        </div>
        <!--备注-->
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="mremark" name="mremark" value="" placeholder="请输入备注" class="layui-input">
            </div>
        </div>
                ...
                <form class="layui-form layui-form-pane" action="" lay-filter="searchForm">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="mdept" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
