...
<div class="main">
    <h2>用户管理</h2>
    <div class="manage">
        <table style="margin-bottom: 5px" class="list">
            <tr>
                <th>ID</th>
                <th>用户类型</th>
                <th>性别</th>
        ...
        当前:${cpage }/${tpage }页
        <a style="margin-left: 10px;margin-right: 10px" href="user?cp=1">首页</a>
        <a style="margin-left: 10px;margin-right: 10px" href="user?cp=${cpage-1<=0 ?1:cpage-1}">上一页</a>
        <a style="margin-left: 10px;margin-right: 10px" href="user?cp=${cpage+1>=tpage ? tpage : cpage+1 }">下一页</a>
        <a style="margin-left: 10px;margin-right: 10px" href="user?cp=${tpage }">尾页</a>
