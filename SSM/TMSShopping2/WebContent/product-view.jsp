            ...
            <div class="buy">
                ...
                <p>
                    购买数量：<input type="button" value="  -  " onclick="jian()"/><input
                        align="middle" type="text" value="1" id="count" name="count" style="font-size: 18px;width: 100px"
                ...
                <div class="button">
                    ...
                    <a  style="position: relative;top: 5px" href="javascript:shopAdd2(${p.EP_ID})">
                        <img style="position: absolute;margin-left: 15px;margin-top: 5px" src="images/加入购物车.png"/>
                        </a>
                </div>
            </div>
            <div class="clear"></div>
