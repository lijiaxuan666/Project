					...
					<form action="GueServlet" method="post">
						<table>
							<tr>
								...
								<td><input class="text" style="width: 550px;" value="${name.EU_USER_ID }" readonly="readonly" name="guestName" /></td>
							...
							<tr>
								...
								<td><textarea id='content_1' style="height: 200px;width: 550px;resize: none;" required oninvalid="setCustomValidity('尊敬的顾客您好，不管您满不满意，您的评论得有点文字');" oninput="setCustomValidity('');" name="guestContent"></textarea></td>
