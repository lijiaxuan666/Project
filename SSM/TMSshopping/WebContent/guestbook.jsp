...
<div id="main" class="wrap">
    ...
    <div class="main">
        <div class="guestbook" style="width: 1000px">
            <h2>全部留言</h2>
            <ul style="height: 700px; width: 1000px;">
                <li>
                    <%
            ...
            <div class="pager">
                <ul class="clearfix">
                    ...
                    %>
                    <li><a href="SelallServlet?page=<%=i%>"><%=i%>
                    </a></li>
                    <%
                        }
                    %>
                ...
                <form action="GueServlet" method="post">
                    <table>
                        <tr>
                            ...
                            <td><input class="text" style="width: 550px;" value="${name.EU_USER_ID }"
                                       readonly="readonly" name="guestName"/></td>
                            <%--								<td style="width: 550px;" name="guestName">${name.EU_USER_ID }</td>--%>
                        </tr>
                        <tr>
                            <td class="field">留言内容：</td>
                            <%--								<td><textarea id="content_1" required="required" name="guestContent"></textarea>--%>
                            <%--								<textarea id='memo' style="height: 50px;width: 70px;resize: none;"></textarea>--%>
                            <td><textarea id='content_1' style="height: 200px;width: 550px;resize: none;" required
                                          oninvalid="setCustomValidity('尊敬的顾客您好，不管您满不满意，您的评论得有点文字');"
                                          oninput="setCustomValidity('');" name="guestContent"></textarea></td>
