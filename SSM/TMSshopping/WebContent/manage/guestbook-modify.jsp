...
<div id="childNav1"><div align="center">
	</div><div align="left"> 
			...
			<form action="UpManage" method="post">
				...
				<table class="form">
					...
					<tr>
						...
						<td><textarea name="Content" readonly="readonly" style="height: 100px;width: 400px;resize: none;" ><%=comment.getEC_CONTENT()%></textarea></td>
					</tr>
					<tr>
						<td class="field">回复内容：</td>
						<td><textarea name="replyContent" style="height: 100px;width: 400px;resize: none;" required oninvalid="setCustomValidity('商店都被诋毁了，店主你得说说话啊！！');" oninput="setCustomValidity('');" ></textarea></td>
					</tr>
					<tr>
						<td></td>
