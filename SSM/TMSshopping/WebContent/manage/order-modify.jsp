						...
						<tr>
							...
							<td><select name="tatus"
								onchange="change(this,${order.EO_STATUS })">
									<option value="1"
										${order.orderStatusStr=="待审核" ? "selected" : ""}>待审核</option>
									<option value="2"
										${order.orderStatusStr=="审核通过" ? "selected" :""}>审核通过</option>
									<option value="3"
										${order.orderStatusStr=="配货" ? "selected" : ""}>配货</option>
									<option value="4"
										${order.orderStatusStr=="发货" ? "selected" : ""}>发货</option>
									<option value="5"
										${order.orderStatusStr=="收货确认" ? "selected" : ""}>收货确认</option>
							</select></td>
						</tr>
						<tr>
							<td></td>
