...
<%-- <%
String WIDout_trade_no = session.getAttribute("WIDout_trade_no");
%> --%>
    ...
    <form name=alipayment action=alipay.trade.page.pay.jsp method=post>
        <div id="body1" class="show" name="divcontent">
            <dl class="content">
                ...
                <dt>付款金额 ：</dt>
                <dd>
                    <input id="WIDtotal_amount_price" name="WIDtotal_amount"
                           value="<%=session.getAttribute("WIDtotal_amount")%>"/>
                </dd>
                <hr class="one_line">
                <dt>商品描述：</dt>
                <dd>
...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDsubject").value = "托马斯零食商城";
